  ...
  <div class="container">
    <div class="jumbotron">
      <div class="row d-flex " style="justify-content: center;">
        <div class="profileMainHeader">
        <h1 class="text-center" id = "welcomeName"><?php echo "Welcome " .  $username ?></h1>
          <?php
          if($result['user_image'] == null){?>
            <i class="fas fa-user-circle" id="userProfilePicDefault"></i>
          <?php } else {?>
        ...
        <div class="col-12">
          <div class="searchArea">
            ...
            <div class="profileSearch">
              <div class="row d-flex" style="justify-content:space-between" id="searchResultsNamePic">
                <h4>Name: <a href="./profile.php?user=<?php echo $row["userName"]; ?>"><?php echo $row["firstName"] . " " . $row["lastName"]; ?></h4>
                  <?php if ($row['user_image'] == ""){ ?>
                    <i class="fas fa-user-circle" id="userProfilePicDefault"></i>
                    <?php } else { ?>
                    <img class="rounded-circle" src=" <?php echo $row['user_image'] ?> " id="userProfilePic">
                  <?php } ?>
              </div>
